...
export async function generateStoryblokMetadata({
  ...
  // Return default metadata if story is not found
  ...
  if (isProdDomain) {
    baseMetadata.alternates = {
      canonical: `https://SELISE.ch/${lang}/${slug.toLowerCase()}`,
      languages: {
        en: `https://SELISE.ch/en/${slug.toLowerCase()}`,
        de: `https://SELISE.ch/de/${slug.toLowerCase()}`,
      },
    };
  }
